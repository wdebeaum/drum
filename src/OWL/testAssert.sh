PBASE=/Applications/Protege_3.4.3
PLIB=${PBASE}/plugins/edu.stanford.smi.protegex.owl
...
cp=.:${PBASE}/protege.jar:${PBASE}/looks.jar:${owlcp}:${pelletcp}

java -Xmx1g -cp ${cp} -Dprotege.dir=${PBASE} -Djava.util.logging.config.file=log4j.properties TRIPS.OWL.testAssert $@
