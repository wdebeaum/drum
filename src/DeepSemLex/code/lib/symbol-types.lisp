...
(common-lisp::deftype dsl::phys-obj-feat ()
  '(common-lisp::member object-function origin form mobility group spatial-abstraction intentional information container kr-type trajectory tangible))

(common-lisp::deftype dsl::situation-feat ()
  '(common-lisp::member aspect time-span cause trajectory locative intentional information container kr-type type origin iobj tangible))

(common-lisp::deftype dsl::abstr-obj-feat ()
  '(common-lisp::member measure-function scale intentional information container gradability kr-type object-function origin intensity orientation tangible))

(common-lisp::deftype dsl::time-feat ()
  '(common-lisp::member time-function scale kr-type))

;; sem-feats whose values are ONT types instead of F:: symbols
(common-lisp::deftype dsl::ont-valued-feat ()
  '(common-lisp::member type scale intensity))

(common-lisp::in-package :vn)
...
(common-lisp::deftype sem-role ()
  ...
  '(common-lisp::member affected affected1 affected-result agent agent1 assoc-with assoc-with1 beneficiary between cause cognizer compar content contents criterion direction donor effect event-of-change experiencer extent figure figure1 formal formal1 goal goal-reln goods ground ground1 indefinite kind location manner money neutral neutral1 neutral2 norole one-of orientation position-reln pro pro-det pro-set quantifier reason refset result scale source source-reln standard
    ;; some I was surprised were no longer there
    of of1 of2 stimulus value
