...
; but put back ONT::MUTATION and ONT::BIOLOGICAL-PROCESS (e.g., tumorigenesis) which were in EVENT-OF-CHANGE
	    (:* (? t1 
;ONT::EVENT-OF-CHANGE 
		   ONT::MUTATION ONT::BIOLOGICAL-PROCESS ONT::CHEMICAL ONT::MOLECULAR-PART ONT::CELL-PART ONT::BODY-PART ONT::SIGNALING-PATHWAY ONT::PHYS-OBJECT ONT::MENTAL-CONSTRUCTION ONT::AWARENESS ONT::INFORMATION-FUNCTION-OBJECT) ?!w) :SEQUENCE - :DRUM ?code)
	   -simple-ref>
	   90
	   (ONT::TERM ?!obj ?t1
	    :name ?!w
...
;	    ))
	  ...
	  (((? reln ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET) ?!obj 
	    (? t1 ONT::MUTATION ONT::BIOLOGICAL-PROCESS ONT::CHEMICAL ONT::MOLECULAR-PART ONT::CELL-PART ONT::BODY-PART ONT::SIGNALING-PATHWAY ) 
...
|#
	  ...
	  (((? reln ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET) ?!obj 
	   ...
	   (ONT::F ?!mod (:* ONT::ASSOC-WITH W::OF) :VAL ?!name2)
	   ((? reln2 ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET) ?!name2 
...
;	    (? type1 ONT::SEQUENCE) :SEQUENCE ?!sequence)
	    (? type1 ONT::MUTATION ONT::CHEMICAL ONT::MOLECULAR-PART ONT::CELL-PART ONT::BODY-PART) :SEQUENCE ?!sequence :operator -)  ; ":operator -" is here to exclude logical sequences (e.g., Ras and Raf)
	   -explicit-ref-seq0a>
	   100
	   (ONT::TERM ?!obj ?type
	    :m-sequence ?!sequence
...
;	    :drum ?code  ; there is no :drum information for :SEQUENCE (so this will be empty)
	  ...
	  (((? reln ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET) ?!obj 
	    (:* (? type ONT::SIGNALING-PATHWAY ONT::MACROMOLECULAR-COMPLEX) ?!w)
	    :ASSOC-WITHS (?!name))
	   (ONT::F ?!name ONT::ASSOC-WITH :VAL ?!nVal)
...
;	    (? type1 ONT::SEQUENCE) :SEQUENCE ?!sequence)
	    (? type1 ONT::MUTATION ONT::CHEMICAL ONT::MOLECULAR-PART ONT::CELL-PART ONT::BODY-PART) :SEQUENCE ?!sequence :operator -)
	   -explicit-ref-seq0a2>
	   100
	   (ONT::TERM ?!obj ?type
	    :m-sequence ?!sequence
...
;	    ONT::SEQUENCE :ELEMENT-TYPE ?!type :SEQUENCE ?!sequence)
	    (? type ONT::MUTATION ONT::CHEMICAL ONT::MOLECULAR-PART ONT::CELL-PART ONT::BODY-PART) :SEQUENCE ?!sequence :operator -)
	   -explicit-ref-seq0b>
	   100
	   (ONT::TERM ?!obj ?type
	    :m-sequence ?!sequence
