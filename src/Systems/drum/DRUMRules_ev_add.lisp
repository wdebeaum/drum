...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	  ...
	  ((ONT::EVENT ?ev ?type :REASON ?!res)
	   ...
	   ((? reln1 ONT::F ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET ONT::TERM) ?!res2  (? t1 ONT::EVENT-OF-CHANGE ONT::CHEMICAL ONT::MOLECULAR-PART ONT::CELL-PART ONT::BODY-PART ONT::SIGNALING-PATHWAY ONT::MUTANT-OBJ ONT::WILDTYPE-OBJ ONT::MEDICAL-DISORDERS-AND-CONDITIONS))
           -result2>
           100
	   (ONT::EVENT ?ev ?type
	    :rule -result2
