...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	  ...
	  ((ONT::EVENT ?ev ?type :RESULT ?!res)
	   ...
	   ((? reln1 ONT::F ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET ONT::TERM) ?!res1  (? t1 ONT::EVENT-OF-CHANGE ONT::CHEMICAL ONT::MOLECULAR-PART
...
ONT::SIGNALING-PATHWAY ONT::MUTANT-OBJ ONT::WILDTYPE-OBJ ))
	  ...
	  ((ONT::EVENT ?ev ?type :REASON ?!res)
	   ...
	   ((? reln1 ONT::F ONT::QUANTIFIER ONT::KIND ONT::A ONT::INDEF-PLURAL ONT::THE ONT::THE-SET ONT::INDEF-SET ONT::BARE ONT::SM ONT::PRO ONT::PRO-SET ONT::TERM) ?!res2  (? t1 ONT::EVENT-OF-CHANGE ONT::CHEMICAL ONT::MOLECULAR-PART
;ONT::CELL-PART ONT::BODY-PART ONT::MEDICAL-DISORDERS-AND-CONDITIONS
ONT::SIGNALING-PATHWAY ONT::MUTANT-OBJ ONT::WILDTYPE-OBJ ))
           -result2>
           100
